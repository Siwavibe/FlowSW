        ...
        "steps": [
          {
            "from": "User",
            "to": "ELS",
            "label": "กดปุ่ม ส่งคำขอคำขอไปตรวจสอบ",
            "stepNum": "1",
            "api": "",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "เจ้าหน้าที่",
            "to": "REG",
            "label": "เมนู นัดล่วงหน้า > Popup เอกสารหลักฐาน",
            "stepNum": "2",
            "api": "",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "REG",
            "to": "ELS",
            "label": "บันทึกผล ตรวจผ่าน/ไม่ผ่าน",
            "stepNum": "2.3",
            "api": "ELS : /elss/els/sand/api/v1/ext/receive-dol/check-evd",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "User",
            "to": "ELS",
            "label": "กรณี ไม่ผ่าน แนบไฟล์รอบที่ n",
            "stepNum": "3",
            "api": "",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "User",
            "to": "ELS",
            "label": "กรณี ตรวจผ่าน กด พิมพ์ใบแจ้งชำระเงิน",
            "stepNum": "4",
          ...
          },
          {
            "from": "เจ้าหน้าที่",
            "to": "EXP",
            "label": "ดำเนินการตามขั้นตอน EXP เจ้าหน้าที่กรอกข้อมูล",
            "stepNum": "9",
            "api": "",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "EXP",
            "to": "ELS",
            "label": "อนุญาต (ผลพิจารณา คณะกรรมการอนุญาต)",
            "stepNum": "9.1",
          ...
          },
          {
            "from": "EXP",
            "to": "ELS",
            "label": "ไม่อนุญาต (ผลพิจารณา คณะกรรมการอนุญาต)",
            "stepNum": "9.2",
          ...
          },
          {
            "from": "ELS",
            "to": "ELV",
            "label": "(อาจจะไม่มี) รอออกใบอนุญาต",
            "stepNum": "10",
      ...
      },
      {
        ...
        "steps": [
          ...
          },
          {
            "from": "เจ้าหน้าที่",
            "to": "EXP",
            "label": "ดำเนินการตามขั้นตอน EXP กรอกข้อมูลใบอนุญาตและแสกนใยอนุญาต",
            "stepNum": "9",
            "api": "",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "EXP",
            "to": "ELS",
            "label": "ส่งข้อมูลใบอนุญาต",
            "stepNum": "9.1",
            "api": "ELS : /ext/requests/workflow/license/issue",
            "params": "",
            "db": "",
          ...
          },
          {
            ...
            "label": "ส่งไฟล์แสกน",
            "stepNum": "9.2",
            "api": "ELS : /ext/requests/workflow/license/issue/upload",
            "params": "",
            "db": "",
            "notes": "ส่งไฟล์ใบอนุญาตดูดทรายมายัง eLicense"
          },
          {
            "from": "ELS",
            "to": "minio",
            "label": "PDFแสกน และ Gen PDF ใส่ Timestamp + CA",
            "stepNum": "9.3",
            "api": "",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "minio",
            "to": "ELV",
            "label": "หยอดค่าใน ELV sec9_license และ paper ",
            "stepNum": "9.5",
            "api": "",
            "params": "",
            "db": "",
      ...
      },
      {
        ...
        "steps": [
          ...
          },
          {
            "from": "ELS",
            "to": "ELV",
            "label": "(flow เดิม) เอาใบอนุญาตเดิม มาใส่คำว่าใบแทน",
            "stepNum": "6",
          ...
          },
          {
            "from": "User",
            "to": "ELS",
            "label": "(flow เดิม) ดาวน์โหลดใบแทน",
            "stepNum": "6.1",
            "api": "",
            "params": "",
            "db": "",
      ...
      },
      {
        ...
        "steps": [
          ...
          },
          {
            "from": "User",
            "to": "ELS",
            "label": "ไม่มีแนบไฟล์ กด พิมพ์ใบแจ้งชำระเงิน",
            "stepNum": "2",
            "api": "กรมบัญชีกลาง : PMT1|BillpaymentManage",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "ELS",
            "to": "ELV",
            "label": "(flow เดิม) คาดใบอนุญาตสีแดง ว่ายกเลิก",
            "stepNum": "4",
          ...
          },
          {
            "from": "User",
            "to": "ELV",
            "label": "(flow เดิม) แสดงใบอุญาต ยกเลิก",
            "stepNum": "4.1",
            "api": "ELV : elss/pdf/api/v1/license/sand/cancel-uploaded",
            "params": "",
            "db": "",
        ...
        "steps": [
          {
            "from": "User",
            "to": "ELS",
            "label": "กรอกข้อมูลค้นหาเอกสารสิทธิ",
            "api": "",
            "params": "",
            "db": "",
            "notes": "",
          ...
          },
          {
            "from": "ELS",
            "to": "PiPr",
            "label": "ค้นหา โฉนด + ผู้ถือกรรมสิทธิ",
          ...
          },
          {
            "from": "ELS",
            "to": "PiPr",
            "label": "ค้นหา น.ส3 + ผู้ถือกรรมสิทธิ",
          ...
          },
          {
            "from": "เจ้าหน้าที่",
            "to": "REG",
            "label": "บันทึกเลขใบอนุญาตในบัญชีคุม",
            "api": "",
            "params": "",
            "db": "",
          ...
          },
          {
            "from": "User",
            "to": "ELS",
            "label": "เมนู ติดตาม กดดำเนินการเพื่อสร้าง คิววันที่ 2",
            "api": "",
            "params": "",
            "db": "",
            "notes": "",
        ...
        "steps": [
          {
            "from": "User",
            "to": "ELS",
            "label": "Popup ค้นหาโครงการ/สำนักงาน",
            "api": "",
            "params": "",
            "db": "",
            "notes": "",
    ...
    "requests": [
      {
        ...
        "steps": [
          ...
          },
          {
            "from": "schedule",
            "to": "REG",
            "label": "ตรวจสอบสถานะ อนุมัติ/จดทะเบียน",
      ...
      },
      {
        ...
        "steps": [
          ...
          },
          {
            "from": "ELV",
            "to": "EXP",
            "label": "ส่งข้อมูลตรวจสอบใบอนุญาต",
          ...
          },
          {
            "from": "User",
            "to": "ELV",
            "label": "ค้นหาใบอนุญาตจัดตั้งสำนักงานช่างรังวัดเอกชน",
            "api": "",
            "params": "",
            "db": "",
            "notes": "ค้นจาก OPS"
          ...
          },
          {
            "from": "User",
            "to": "ELV",
            "label": "ค้นหาใบอนุญาตจัดสรรที่ดิน",
            "api": "",
            "params": "",
            "db": "",
            "notes": "ค้นจาก OPS"
